<nav class="sidebar">
  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      {{--<li class="nav-item nav-category">Objednavky</li>--}}
      {{--<li class="nav-item {{ active_class(['/']) }}">--}}
        {{--<a href="{{ url('/orders/all') }}" class="nav-link">--}}
            {{--<i class="link-icon" data-feather="hash"></i>--}}
          {{--<span class="link-title">Vsetky</span>--}}
        {{--</a>--}}
      {{--</li>--}}
      <li class="nav-item nav-category">Eshop</li>
      <li class="nav-item {{ active_class(['orders/*']) }}">
        <a class="nav-link" data-toggle="collapse" href="#email" role="button" aria-expanded="{{ is_active_route(['orders/*']) }}" aria-controls="email">
          <i class="link-icon" data-feather="mail"></i>
          <span class="link-title">Objednávky</span>
          <i class="link-arrow" data-feather="chevron-down"></i>
        </a>
        <div class="collapse {{ show_class(['orders/*']) }}" id="email">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="{{ url('/orders/all') }}" class="nav-link {{ active_class(['orders/all']) }}">Všetky</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/orders/completed') }}" class="nav-link {{ active_class(['orders/completed']) }}">Vybavené</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/orders/in-progress') }}" class="nav-link {{ active_class(['orders/in-progress']) }}">Aktívne</a>
            </li>
          </ul>
        </div>
      </li>
        <li class="nav-item nav-category">Taxi</li>
        <li class="nav-item {{ active_class(['taxi/*']) }}">
            <a class="nav-link" data-toggle="collapse" href="#email" role="button" aria-expanded="{{ is_active_route(['taxi/*']) }}" aria-controls="email">
                <i class="link-icon" data-feather="mail"></i>
                <span class="link-title">Vodiči</span>
                <i class="link-arrow" data-feather="chevron-down"></i>
            </a>
            <div class="collapse {{ show_class(['taxi/*']) }}" id="email">
                <ul class="nav sub-menu">
                    <li class="nav-item">
                        <a href="{{ url('/taxi/drivers') }}" class="nav-link {{ active_class(['taxi/drivers']) }}">Všetci</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('/taxi/drivers-active') }}" class="nav-link {{ active_class(['taxi/drivers-active']) }}">Aktívni</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('/taxi/map') }}" class="nav-link {{ active_class(['taxi/map']) }}">Mapa</a>
                    </li>
                    {{--<li class="nav-item">--}}
                        {{--<a href="{{ url('/orders/completed') }}" class="nav-link {{ active_class(['orders/completed']) }}">Vybavené</a>--}}
                    {{--</li>--}}
